...
urlpatterns = patterns('',
    ...
    url(r'^Clearance$', 'warehouse.views.clearance', name='warehouse-index-test'),
    url(r'^Clearance2$', 'warehouse.views.clearance2', name='warehouse-index-test'),
    url(r'^ConfirmClearance-end/(?P<pid>\d+)$', 'warehouse.views.clear_end', name='warehouse-index-test'),
    url(r'^ConfirmClearance/(?P<pid>\d+)$', 'warehouse.views.confirm_clearance', name='warehouse-index-test'),
