...
urlpatterns = patterns('',
                       ...
                       url(r'^(?P<org>\S+)CustomerReturn-next/(?P<pid>\d+)/(?P<kid>\d+)$', 'warehouse.views.customer_return_next2',
                           name='warehouse-index-tiny_order'),
                       url(r'^(?P<org>\S+)ConfirmReturn/(?P<pid>\d+)/(?P<kid>\d+)/(?P<cid>\d+)/(?P<type>\S+)$', 'warehouse.views.confirm_return',
                           name='warehouse-index-tiny_order'),
                       ...
                       url(r'^(?P<org>\S+)ReportReceipt_Panel/(?P<menu_id>\d+)$', 'warehouse.views.report_receipt_panel',
                           name='warehouse-index-tiny_order'),
                       url(r'^(?P<org>\S+)WRHgardani-Panel$', 'warehouse.views.wrh_gardaani',
                           name='warehouse-index-tiny_order'),
                       url(r'^(?P<org>\S+)Print$', 'warehouse.views.printt',
                           name='warehouse-index-tiny_order'),
                       url(r'^(?P<org>\S+)PrintDif$', 'warehouse.views.print_dif',
                           name='warehouse-index-tiny_order'),
                       url(r'^(?P<org>\S+)WRHGardaniConfirmation$', 'warehouse.views.wrh_gardaani_confirm',
                           name='warehouse-index-tiny_order'),
